 ...
 *
 * FTCMotor is a basic implementation of a motor used for FTC.
 * Basic FTC motors can be controlled using motor power but can
 * not have their positions set using encoders. If you wish to
 * set a motors position
 * @see FTCTargetMotor
 *
