 ...
 *
 * The Debugger also has different debug levels, so that the user can easily
 * switch the amount of information they are getting. For example, the user would
 * want a lot of information about a particular part when they are fixing a problem
 * or tuning the robot, but only important information when they are driving in a competition
 *
...
public abstract class Debugger {
    enum Level{
        ...
        /**
         * The override can be used to override the level system and ouput any information
         * Overrides are always enabled
         */
        OVERRIDE(-1),
        
        /**
         * Error Debugs should never be Turned off. Error debugs will display when
         * anything that is critical to robot operation occurs
         */
        ERROR(0),
        
        /**
         * Competition debugs should contain information that is important to the drive team
        ...
        /**
         * Test debugs should be used when testing functionality of a process or mechanism,
         * Tests should contain simple and important information to the process rather than
         * an in depth look on how everything is working.
         */
        TEST(3),
        ...
        /**
         * Each debug level has a rank, the lower the rank, the more important.
         * For example, if running debug level 3, information from levels 3, 2, 1, and 0
         * will be debugged.
         *
         * Ranks should not be lower than 0
         */
        int rank;
